...
class Tringle {
    constructor(genome) {
        ...
        this.accel = createVector(0, 0.01).rotate(random(2 * PI));
    ...
    show(s) {
        ...
        if (showGaze)
            this.gaze.show()
        stroke(255, 255, 255);
        line(this.pos.x, this.pos.y, this.seenTarget ? this.seenTarget.x : this.pos.x, this.seenTarget ? this.seenTarget.y : this.pos.y);
      }
