...
export default async function Home() {
  ...
  return (
    <div>
      ...
      <p className="text-slate-600 dark:text-slate-200 ml-4">Official website of Mark Christian (TheChickenKnight)</p>
      <a href="https://steamcommunity.com/profiles/76561198420907011" target="_blank"><SteamIcon className="inline mt-1 hover:fill-indigo-950 dark:hover:fill-zinc-300 hover:mt-0 duration-75 ml-4"/></a>
